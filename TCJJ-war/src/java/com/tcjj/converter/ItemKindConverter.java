 ...
 * @author kevindong
 */
@FacesConverter("itemKindConverter")
public class ItemKindConverter implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        if (value.trim().equals("")) {
            ...
            try {
                ItemKind entity = itemKindBean.findById(Integer.parseInt(value));
                if (entity != null) {
                    return entity;
                } else {
                    return null;
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        if (value == null || value.equals("")) {
            ...
            return ((ItemKind) value).getId().toString();
        }
    }
